...
void SystemManager::upload() {
    ...
    // WiFi sudah konek di titik ini -- kalau ada flag "butuh resync"
    // (ditandai BootManager saat mendeteksi brownout), numpang sesi
    // WiFi yang sudah ada ini untuk NTP sync, TANPA menyalakan WiFi
    // ekstra khusus untuk ini. Kalau NTP gagal (mis. jaringan blokir
    // UDP/123), flag TIDAK dianggap terpakai -- coba lagi di sesi
    // upload berikutnya.
