...
bool CC1101Driver::begin() {
    ...
    // Interrupt dipasang sekali di sini dan TIDAK PERNAH dilepas lagi --
    // radio dimaksudkan menyala terus (continuous RX) selama device
    // hidup, tidak ada lagi fase "matikan radio sebelum sleep".
